...
void rad2grad(const T &rad, S &gr, S &mi, T &se) {
  T h1, diff = 1.E-4;
...
template <class T, class S>
void deg2QString(const S &gr, const S &mi, const T &se, QString &qsdeg) {
...
template <class T, class S>
void deg2QStringGoogle(const S &gr, const S &mi, const T &se, QString &qsdeg) {
  double setmp = (double)se;
...
template <class T, class S>
T degrees2rad(const S &gr, const S &mi, const T &se) {
