...
#else
#define GLM_HAS_STATIC_ASSERT ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_GCC)) ||  \
...
#define GLM_HAS_CONSTEXPR_PARTIAL GLM_HAS_CONSTEXPR
#else
#define GLM_HAS_CONSTEXPR ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC15)) || \
...
#else
#define GLM_HAS_INITIALIZER_LISTS ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_GCC)) ||                                       \
                                                                        ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) || \
...
#else
#define GLM_HAS_DEFAULTED_FUNCTIONS ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_GCC)) ||                                       \
                                                                          ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) || \
...
#else
#define GLM_HAS_RVALUE_REFERENCES ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_GCC)) || \
                                                                        ((GLM_COMPILER & GLM_COMPILER_VC)) ||  \
                                                                        ((GLM_COMPILER & GLM_COMPILER_CUDA))))
#endif
...
#else
#define GLM_HAS_EXPLICIT_CONVERSION_OPERATORS ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_GCC)) ||                                             \
...
#else
#define GLM_HAS_ALIGNOF ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_GCC) && (GLM_COMPILER >= GLM_COMPILER_GCC48)) ||     \
