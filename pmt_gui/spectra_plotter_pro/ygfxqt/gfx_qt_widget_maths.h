...
public:
  ...
  YMathOpenGLWidget *setAxesOrders(AxisOrder x, AxisOrder y) {
    x_axis_order = x;
    y_axis_order = y;
    update();
    return this;
  }
  YMathOpenGLWidget *setAxesScales(AxisScale x, AxisScale y) {
    x_axis_scale = x;
    y_axis_scale = y;
    update();
    return this;
  }
  YMathOpenGLWidget *setShader(std::shared_ptr<ygfx::Shader> shader) {
    current_shader = shader;
    update();
    return this;
  }
  YMathOpenGLWidget *setRulerBackgroundColor(QColor const &color) {
    color_ruler_bg = color;
    update();
    return this;
  }
  YMathOpenGLWidget *setRulerTextColor(QColor const &color) {
    color_ruler_text = color;
    update();
    return this;
  }
  YMathOpenGLWidget *setBackgroundColor(QColor const &color) {
    color_background = color;
    update();
    return this;
  }
  YMathOpenGLWidget *setGridColor(QColor const &color) {
    color_grid = color;
    update();
    return this;
  }
  YMathOpenGLWidget *setAxisColor(QColor const &color) {
    color_axis = color;
    update();
    return this;
  }
  YMathOpenGLWidget *setPlotOptions(PlotOptions options) {
    options_plot = options;
    return this;
  }
  YMathOpenGLWidget *setPlotOption(PlotOption option, bool value = true) {
    options_plot.setFlag(option, value);
    return this;
  }
  YMathOpenGLWidget *setMouseOptions(MouseOptions options) {
    options_mouse = options;
    return this;
  }
  YMathOpenGLWidget *setMouseSnappingOptions(MouseSnapOptions options) {
    options_mouse_snap = options;
    return this;
  }
  YMathOpenGLWidget *setMaximumPlotPosition(double maxx, double maxy) {
    maximum_plot_position = glm::dvec2(maxx, maxy);
    return this;
  }
  YMathOpenGLWidget *setMinimumPlotPosition(double minx, double miny) {
    minimum_plot_position = glm::dvec2(minx, miny);
    return this;
  }
  YMathOpenGLWidget *setXAxisText(QString const &label) {
    label_x_axis = label;
    return this;
  }
  YMathOpenGLWidget *setYAxisText(QString const &label) {
    label_y_axis = label;
    return this;
  }
