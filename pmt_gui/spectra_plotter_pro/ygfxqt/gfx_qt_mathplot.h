...
public:
  ...
  ~OneTimeStopWatch() {
    auto nanoseconds = std::chrono::duration_cast<std::chrono::nanoseconds>(std::chrono::system_clock::now() - tp_start_).count();
...
public:
  ...
  YMathGfxPlot *setMinX(double x) {
    bounding_box_min.x = x;
    return this;
  }
  YMathGfxPlot *setMinY(double y) {
    bounding_box_min.y = y;
    return this;
  }
  YMathGfxPlot *setMaxX(double x) {
    bounding_box_max.x = x;
    return this;
  }
  YMathGfxPlot *setMaxY(double y) {
    bounding_box_max.y = y;
    return this;
  }
  YMathGfxPlot *setVisible(bool vis) {
    visible = vis;
    return this;
  }
  YMathGfxPlot *setDrawMode(GLenum new_drawmode) {
    drawmode = new_drawmode;
    return this;
  }
  YMathGfxPlot *setTexture(QOpenGLTexture *new_texture) {
    texture = new_texture;
    return this;
  }
  YMathGfxPlot *setCustomShader(ygfx::spShader shader) {
    customshader = shader;
    return this;
  }
  YMathGfxPlot *setDrawingOffset(GLint offset) {
    draw_offset = offset;
    return this;
  }
  YMathGfxPlot *setDrawingSize(GLsizei size) {
    draw_size = size;
    return this;
  }
  YMathGfxPlot *setBaseColor(QColor const &color) {
    color_base = color;
    return this;
  }
