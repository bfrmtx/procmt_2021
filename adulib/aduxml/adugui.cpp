...
void adugui::on_JobTablepushButton_clicked() {
  if (this->jobtimetable == nullptr)
    this->jobtimetable = new QTableView(0);
...
void adugui::on_set_exmode(bool set_true_false) {
  ...
  if (set_true_false == true) {
    ...
    for (auto &btn : this->posbtns) {
      if (btn->xml_name == "pos_y1" && btn->channel_no == 0)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_y2" && btn->channel_no == 0)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z1" && btn->channel_no == 0)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z2" && btn->channel_no == 0)
        btn->btn->setEnabled(true);

      if (btn->xml_name == "pos_x1" && btn->channel_no == 1)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_x2" && btn->channel_no == 1)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z1" && btn->channel_no == 1)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z2" && btn->channel_no == 1)
        btn->btn->setEnabled(true);

      if (btn->xml_name == "pos_x1" && btn->channel_no == 2)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_x2" && btn->channel_no == 2)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_y1" && btn->channel_no == 2)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_y2" && btn->channel_no == 2)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z1" && btn->channel_no == 2)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z2" && btn->channel_no == 2)
        btn->btn->setEnabled(true);

      if (btn->xml_name == "pos_x1" && btn->channel_no == 3)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_x2" && btn->channel_no == 3)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_y1" && btn->channel_no == 3)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_y2" && btn->channel_no == 3)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z1" && btn->channel_no == 3)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z2" && btn->channel_no == 3)
        btn->btn->setEnabled(true);

      if (btn->xml_name == "pos_x1" && btn->channel_no == 4)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_x2" && btn->channel_no == 4)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_y1" && btn->channel_no == 4)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_y2" && btn->channel_no == 4)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z1" && btn->channel_no == 4)
        btn->btn->setEnabled(true);
      if (btn->xml_name == "pos_z2" && btn->channel_no == 4)
        btn->btn->setEnabled(true);
    }
  } else {
    for (auto &btn : this->posbtns) {
...
void pos_button::on_clicked() {
  ...
  if (this->needs_flip && !gui->exmode) {
    ...
    this->keyp->setInitialValue(this->value);
...
void triple_button::on_change_sensor_type() {
  ...
  if (this->sdb == nullptr) {
    ...
    qDebug() << "using connection" << this->sdb->get_connection_name();
