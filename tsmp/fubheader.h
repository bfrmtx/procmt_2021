...
*/
class FUBHeader : public ITSHeader
{
public:
    FUBHeader();
    ...
    */
    ...
    virtual string get_result_selftest() const {return "";}
...
size_t Samples;
double LSBVal;
long int atsDateTime;
double SampleFreq, SampleSec;
double Gain;
size_t goe_nc;
string ChannelType;
string sensor_cal_file_name;
string system_cal_file_name;
