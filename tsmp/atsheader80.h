...
#ifndef ATSHeader80_H
#define ATSHeader80_H
...
*/
class ATSHeader80 : public ITSHeader
{
public:
    ...
    */
    ...
    virtual string get_xmlheader() const;
    ...
    virtual size_t get_channel_no() const;
...
protected:
    ...
    struct xheader {
        ...
        short int SerNoADU;                                  /*!< ref. to manual*/
        short int SerNoADB;                                  /*!< ref. to manual*/
        char ChanNo;                                		/*!< ref. to manual*/
        char cSensorChopper;
        ...
        short int   siCSAMTBlocks;                 //!< 0F4h
        short int   siCSAMTStacksPBlock;           //!< 0F6h
        int     iCSAMTBlockLength;             //!< 0F8h
        char     abyADBBoardType[4];
        ...
        char cskip7[64];                                              /*!< was 112 */
        char Achxmlheader[64];                                            /*!< ref. to manual*/
    ...
    char ChanNo;                                                  /*!< ref. to manual*/
    char cSensorChopper;
    // eigentlich muesste ein byte gelesen und konvertiert werden; geht aber mit 2 byte
    ...
    short int   siCSAMTStacksPBlock;           //!< 0F6h
    int     iCSAMTBlockLength;             //!< 0F8h
    char     abyADBBoardType[4];                                               /*!< ref. to manual*/
