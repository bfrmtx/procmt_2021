 ...
 */
template <typename T>
void make_d_r_i(const std::vector<T> &Hx, const std::vector<T> &Hy, const std::vector<T> &Exy, std::vector<double> &dr, std::vector<double> &di) {
 ...
 */
template <typename T>
void make_mest_ri(const std::vector<T> &Hx, const std::vector<T> &Hy,
...
void make_residuals(std::vector<S> &er, std::vector<S> &ei,
...
template <typename T, typename S>
void make_exy_iter(const std::vector<S> &wr, const std::vector<S> &wi,
...
template <typename T, typename S>
void make_exy_pred(std::vector<T> &Exy, const std::vector<T> &Hx, const std::vector<T> &Hy,
