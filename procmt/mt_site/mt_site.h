 ...
 */
template<typename T> std::vector<T> make_d(const std::vector<T> &Hx, const std::vector<T> &Hy, const std::vector<T> &Exy) {
 ...
 */
template<typename T> std::vector<T> make_mest(const std::vector<T> &Hx, const std::vector<T> &Hy,
