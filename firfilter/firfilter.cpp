...
void firfilter::clear() {
  ...
  insert("filter_outputs", (quint64)0);
...
std::vector<double> firfilter::generate_coefficients(const QString &filter_name, bool &success, const bool create_coeff_vector,
  ...
  if (0 == filter_name.compare("mtx16")) {
    ...
    insert("filter_name", filter_name);
    insert("filter_type", QString("decimation"));
    insert("filter_long_description", QString("metronix 16x decimation FIR with Remez"));
    insert("filter_category", QString("FIR"));
    insert("filter_move", (quint64)16);
    insert("filter_length", (quint64)351);
    insert("filter_outputs", (quint64)1);
    if ((this->quint64value("filter_length") > this->quint64value("num_samples")) && this->quint64value("num_samples")) {
      success = false;
      if (create_coeff_vector)
    ...
    if (create_coeff_vector) {
      ...
      coeff.resize(351);
      i = 0;
      coeff[i++] = 4.698984408285940364e-11;
      coeff[i++] = 2.011037619158187298e-10;
      coeff[i++] = 5.667424859559532524e-10;
      coeff[i++] = 1.248971746897866548e-09;
      coeff[i++] = 2.495431564969737367e-09;
      coeff[i++] = 4.461932627474120504e-09;
      coeff[i++] = 7.258525017264040052e-09;
      coeff[i++] = 1.072533584375917252e-08;
      coeff[i++] = 1.481169914065258257e-08;
      coeff[i++] = 1.898995041320389440e-08;
      coeff[i++] = 2.259440034425563242e-08;
      coeff[i++] = 2.452974737422405701e-08;
      coeff[i++] = 2.440476675508834538e-08;
      coeff[i++] = 2.150104991506310731e-08;
      coeff[i++] = 1.566588358429836372e-08;
      coeff[i++] = 6.622148453197989282e-09;
      coeff[i++] = -4.272281005766410430e-09;
      coeff[i++] = -1.646553887748547078e-08;
      coeff[i++] = -2.918690797753253944e-08;
      coeff[i++] = -4.319847763483421090e-08;
      coeff[i++] = -5.831905936795312060e-08;
      coeff[i++] = -7.712797965838905250e-08;
      coeff[i++] = -1.026711675594686269e-07;
      coeff[i++] = -1.399898910979508369e-07;
      coeff[i++] = -1.914817056952556369e-07;
      coeff[i++] = -2.605409207107624764e-07;
      coeff[i++] = -3.473481140137078893e-07;
      coeff[i++] = -4.502218875450886047e-07;
      coeff[i++] = -5.603864835872242828e-07;
      coeff[i++] = -6.665982919550806235e-07;
      coeff[i++] = -7.513991856405957979e-07;
      coeff[i++] = -7.936305656788549045e-07;
      coeff[i++] = -7.649620434043223247e-07;
      coeff[i++] = -6.343402675682385809e-07;
      coeff[i++] = -3.650083807471431034e-07;
      coeff[i++] = 8.393025957891297698e-08;
      coeff[i++] = 7.588361165810966603e-07;
      coeff[i++] = 1.710675608171521014e-06;
      coeff[i++] = 2.996252907253967969e-06;
      coeff[i++] = 4.678370975083839559e-06;
      coeff[i++] = 6.821455612382502459e-06;
      coeff[i++] = 9.495121237083457104e-06;
      coeff[i++] = 1.276981387461428803e-05;
      coeff[i++] = 1.671829853999964836e-05;
      coeff[i++] = 2.140239705408770090e-05;
      coeff[i++] = 2.688315227123703511e-05;
      coeff[i++] = 3.320961478738369409e-05;
      coeff[i++] = 4.042370452196763640e-05;
      coeff[i++] = 4.853821945968688877e-05;
      coeff[i++] = 5.755605594877471592e-05;
      coeff[i++] = 6.745222117740555035e-05;
      coeff[i++] = 7.818313514693736273e-05;
      coeff[i++] = 8.965740514591830502e-05;
      coeff[i++] = 1.017637087149118787e-04;
      coeff[i++] = 1.143474809176123685e-04;
      coeff[i++] = 1.272248597449802054e-04;
      coeff[i++] = 1.401512616089767304e-04;
      coeff[i++] = 1.528557430203637683e-04;
      coeff[i++] = 1.650172139060232339e-04;
      coeff[i++] = 1.762827733592084499e-04;
      coeff[i++] = 1.862424388972608574e-04;
      coeff[i++] = 1.944648706919089394e-04;
      coeff[i++] = 2.004798192998774153e-04;
      coeff[i++] = 2.037985269020207014e-04;
      coeff[i++] = 2.039038374210797348e-04;
      coeff[i++] = 2.002789931602418137e-04;
      coeff[i++] = 1.924033037923480018e-04;
      coeff[i++] = 1.797702049435091797e-04;
      coeff[i++] = 1.619004128476075595e-04;
      coeff[i++] = 1.383538234043093574e-04;
      coeff[i++] = 1.087434602894613299e-04;
      coeff[i++] = 7.274500482066686470e-05;
      coeff[i++] = 3.013592414228851750e-05;
      coeff[i++] = -1.921942412642417019e-05;
      coeff[i++] = -7.533661393235502519e-05;
      coeff[i++] = -1.381171237495848719e-04;
      coeff[i++] = -2.072876344511578796e-04;
      coeff[i++] = -2.824482914821029164e-04;
      coeff[i++] = -3.630249045914782065e-04;
      coeff[i++] = -4.482960126818107257e-04;
      coeff[i++] = -5.373228941691505231e-04;
      coeff[i++] = -6.290312753141148782e-04;
      coeff[i++] = -7.221585815412771359e-04;
      coeff[i++] = -8.153037517096865458e-04;
      coeff[i++] = -9.068662494195949908e-04;
      coeff[i++] = -9.951521715742626256e-04;
      coeff[i++] = -1.078329058381133528e-03;
      coeff[i++] = -1.154493762301838766e-03;
      coeff[i++] = -1.221640384061100596e-03;
      coeff[i++] = -1.277771731950756327e-03;
      coeff[i++] = -1.320873455105748629e-03;
      coeff[i++] = -1.348987673830933818e-03;
      coeff[i++] = -1.360225582945146210e-03;
      coeff[i++] = -1.352856908519042703e-03;
      coeff[i++] = -1.325310740994224646e-03;
      coeff[i++] = -1.276235859546312728e-03;
      coeff[i++] = -1.204564016950687797e-03;
      coeff[i++] = -1.109546368130433138e-03;
      coeff[i++] = -9.907817522178425252e-04;
      coeff[i++] = -8.482412552127879812e-04;
      coeff[i++] = -6.823750571603449640e-04;
      coeff[i++] = -4.940683063779736234e-04;
      coeff[i++] = -2.846912199305889337e-04;
      coeff[i++] = -5.606775343412803822e-05;
      coeff[i++] = 1.893941872784797348e-04;
      coeff[i++] = 4.488429130343978934e-04;
      coeff[i++] = 7.189202393318238444e-04;
      coeff[i++] = 9.958595497457011989e-04;
      coeff[i++] = 1.275361822251016870e-03;
      coeff[i++] = 1.552827155787880539e-03;
      coeff[i++] = 1.823288094582692755e-03;
      coeff[i++] = 2.081569507101859329e-03;
      coeff[i++] = 2.322203755281414348e-03;
      coeff[i++] = 2.539723026890972762e-03;
      coeff[i++] = 2.728593543951910068e-03;
      coeff[i++] = 2.883412618092077648e-03;
      coeff[i++] = 2.998892832143867666e-03;
      coeff[i++] = 3.070157279468779723e-03;
      coeff[i++] = 3.092675738865042524e-03;
      coeff[i++] = 3.062454778316583102e-03;
      coeff[i++] = 2.976113573559318378e-03;
      coeff[i++] = 2.831100772247879815e-03;
      coeff[i++] = 2.625634612086210663e-03;
      coeff[i++] = 2.358827711142610049e-03;
      coeff[i++] = 2.030869311756069995e-03;
      coeff[i++] = 1.643068813259168258e-03;
      coeff[i++] = 1.197811242090310920e-03;
      coeff[i++] = 6.985540093528660229e-04;
      coeff[i++] = 1.501253484068392440e-04;
      coeff[i++] = -4.414993432169901297e-04;
      coeff[i++] = -1.069196651669250368e-03;
      coeff[i++] = -1.724880634614999039e-03;
      coeff[i++] = -2.399079285775649814e-03;
      coeff[i++] = -3.081499938554727123e-03;
      coeff[i++] = -3.760929564335698493e-03;
      coeff[i++] = -4.425634877200062059e-03;
      coeff[i++] = -5.062803414392775571e-03;
      coeff[i++] = -5.659486741245372404e-03;
      coeff[i++] = -6.202329669867626995e-03;
      coeff[i++] = -6.678184544035480931e-03;
      coeff[i++] = -7.073407997421765278e-03;
      coeff[i++] = -7.375162471906475045e-03;
      coeff[i++] = -7.570900437627731995e-03;
      coeff[i++] = -7.649153536216085104e-03;
      coeff[i++] = -7.598686397228324348e-03;
      coeff[i++] = -7.410070156744556942e-03;
      coeff[i++] = -7.074874137211314452e-03;
      coeff[i++] = -6.586552129623385668e-03;
      coeff[i++] = -5.939478428509298129e-03;
      coeff[i++] = -5.130638424544914714e-03;
      coeff[i++] = -4.158538987493642231e-03;
      coeff[i++] = -3.024083386004990017e-03;
      coeff[i++] = -1.729551552608869433e-03;
      coeff[i++] = -2.801952150248190323e-04;
      coeff[i++] = 1.317037159126136165e-03;
      coeff[i++] = 3.052761857778944418e-03;
      coeff[i++] = 4.916130674905514614e-03;
      coeff[i++] = 6.893575615662095833e-03;
      coeff[i++] = 8.970081998011626007e-03;
      coeff[i++] = 1.112870861500410771e-02;
      coeff[i++] = 1.335136971746209329e-02;
      coeff[i++] = 1.561815572088734796e-02;
      coeff[i++] = 1.790834698709554973e-02;
      coeff[i++] = 2.020028986665073703e-02;
      coeff[i++] = 2.247183965135583772e-02;
      coeff[i++] = 2.470043473808594681e-02;
      coeff[i++] = 2.686357626705110357e-02;
      coeff[i++] = 2.893910988675048659e-02;
      coeff[i++] = 3.090520817451294922e-02;
      coeff[i++] = 3.274126372357665654e-02;
      coeff[i++] = 3.442761862732585110e-02;
      coeff[i++] = 3.594623535205383746e-02;
      coeff[i++] = 3.728017173863030359e-02;
      coeff[i++] = 3.841520141663670035e-02;
      coeff[i++] = 3.933871914161483907e-02;
      coeff[i++] = 4.004070551222074087e-02;
      coeff[i++] = 4.051276206497729515e-02;
      coeff[i++] = 4.075018588802085256e-02;
      coeff[i++] = 4.075018588802083869e-02;
      coeff[i++] = 4.051296571807202346e-02;
      coeff[i++] = 4.004052070255117307e-02;
      coeff[i++] = 3.933871914161484601e-02;
      coeff[i++] = 3.841520141663671423e-02;
      coeff[i++] = 3.728033677523544254e-02;
      coeff[i++] = 3.594610722928077984e-02;
      coeff[i++] = 3.442761862732584416e-02;
      coeff[i++] = 3.274126372357664960e-02;
      coeff[i++] = 3.090526593748704753e-02;
      coeff[i++] = 2.893905373388097613e-02;
      coeff[i++] = 2.686357626705109664e-02;
      coeff[i++] = 2.470043473808594681e-02;
      coeff[i++] = 2.247172295954231319e-02;
      coeff[i++] = 2.020030070687436896e-02;
      coeff[i++] = 1.790834698709554973e-02;
      coeff[i++] = 1.561815572088734796e-02;
      coeff[i++] = 1.335102726431701067e-02;
      coeff[i++] = 1.112876732595394214e-02;
      coeff[i++] = 8.970081998011626007e-03;
      coeff[i++] = 6.893575615662096701e-03;
      coeff[i++] = 4.915539860486663713e-03;
      coeff[i++] = 3.052843001239557898e-03;
      coeff[i++] = 1.317037159126136165e-03;
      coeff[i++] = -2.801952150248191407e-04;
      coeff[i++] = -1.730376592211224336e-03;
      coeff[i++] = -3.024004152623692605e-03;
      coeff[i++] = -4.158538987493641363e-03;
      coeff[i++] = -5.130638424544917316e-03;
      coeff[i++] = -5.940485898694524737e-03;
      coeff[i++] = -6.586492685202684737e-03;
      coeff[i++] = -7.074874137211314452e-03;
      coeff[i++] = -7.410070156744558677e-03;
      coeff[i++] = -7.599793724198942654e-03;
      coeff[i++] = -7.649122769380296838e-03;
      coeff[i++] = -7.570900437627733730e-03;
      coeff[i++] = -7.375162471906475913e-03;
      coeff[i++] = -7.074515324392384452e-03;
      coeff[i++] = -6.678182596598288522e-03;
      coeff[i++] = -6.202329669867627862e-03;
      coeff[i++] = -5.659486741245373272e-03;
      coeff[i++] = -5.063810884578004781e-03;
      coeff[i++] = -4.425655414668288982e-03;
      coeff[i++] = -3.760929564335698059e-03;
      coeff[i++] = -3.081499938554726689e-03;
      coeff[i++] = -2.399904325378004067e-03;
      coeff[i++] = -1.724914068350123873e-03;
      coeff[i++] = -1.069196651669250368e-03;
      coeff[i++] = -4.414993432169900755e-04;
      coeff[i++] = 1.495345339879891838e-04;
      coeff[i++] = 6.985173985579665309e-04;
      coeff[i++] = 1.197811242090310703e-03;
      coeff[i++] = 1.643068813259168258e-03;
      coeff[i++] = 2.030526858610986942e-03;
      coeff[i++] = 2.358795501924837099e-03;
      coeff[i++] = 2.625634612086211531e-03;
      coeff[i++] = 2.831100772247880249e-03;
      coeff[i++] = 2.975996881745794284e-03;
      coeff[i++] = 3.062431320856776485e-03;
      coeff[i++] = 3.092675738865042091e-03;
      coeff[i++] = 3.070157279468779723e-03;
      coeff[i++] = 2.998950595117952974e-03;
      coeff[i++] = 2.883399058781005268e-03;
      coeff[i++] = 2.728593543951910502e-03;
      coeff[i++] = 2.539723026890971895e-03;
      coeff[i++] = 2.322368791886545922e-03;
      coeff[i++] = 2.081564582028233492e-03;
      coeff[i++] = 1.823288094582692972e-03;
      coeff[i++] = 1.552827155787880322e-03;
      coeff[i++] = 1.275565475345733033e-03;
      coeff[i++] = 9.958607017646239467e-04;
      coeff[i++] = 7.189202393318238444e-04;
      coeff[i++] = 4.488429130343978934e-04;
      coeff[i++] = 1.895789969480485358e-04;
      coeff[i++] = -5.606332757692489727e-05;
      coeff[i++] = -2.846912199305888253e-04;
      coeff[i++] = -4.940683063779737318e-04;
      coeff[i++] = -6.822469343872910241e-04;
      coeff[i++] = -8.482358751365791155e-04;
      coeff[i++] = -9.907817522178425252e-04;
      coeff[i++] = -1.109546368130433355e-03;
      coeff[i++] = -1.204507864081178631e-03;
      coeff[i++] = -1.276231026525107698e-03;
      coeff[i++] = -1.325310740994224863e-03;
      coeff[i++] = -1.352856908519042486e-03;
      coeff[i++] = -1.360236423168777707e-03;
      coeff[i++] = -1.348984072567751841e-03;
      coeff[i++] = -1.320873455105749062e-03;
      coeff[i++] = -1.277771731950756110e-03;
      coeff[i++] = -1.221699095010938488e-03;
      coeff[i++] = -1.154491467974036369e-03;
      coeff[i++] = -1.078329058381133744e-03;
      coeff[i++] = -9.951521715742626256e-04;
      coeff[i++] = -9.069473928802089047e-04;
      coeff[i++] = -8.153025027379397736e-04;
      coeff[i++] = -7.221585815412771359e-04;
      coeff[i++] = -6.290312753141149866e-04;
      coeff[i++] = -5.374021275504482602e-04;
      coeff[i++] = -4.482954459393247767e-04;
      coeff[i++] = -3.630249045914782065e-04;
      coeff[i++] = -2.824482914821030248e-04;
      coeff[i++] = -2.073470788718574827e-04;
      coeff[i++] = -1.381169226458230006e-04;
      coeff[i++] = -7.533661393235503874e-05;
      coeff[i++] = -1.921942412642416341e-05;
      coeff[i++] = 3.010515730650119629e-05;
      coeff[i++] = 7.274500482066686470e-05;
      coeff[i++] = 1.087432591856994315e-04;
      coeff[i++] = 1.383532566618234083e-04;
      coeff[i++] = 1.618972164386669956e-04;
      coeff[i++] = 1.797679106157061600e-04;
      coeff[i++] = 1.923997025291661063e-04;
      coeff[i++] = 2.002741601390368379e-04;
      coeff[i++] = 2.039189948130981449e-04;
      coeff[i++] = 2.037941010448175673e-04;
      coeff[i++] = 2.004786672809543422e-04;
      coeff[i++] = 1.944697957655352918e-04;
      coeff[i++] = 1.862894319434590462e-04;
      coeff[i++] = 1.763062308190153384e-04;
      coeff[i++] = 1.650494231237963744e-04;
      coeff[i++] = 1.528923538152632874e-04;
      coeff[i++] = 1.402213061390010290e-04;
      coeff[i++] = 1.272453972132075084e-04;
      coeff[i++] = 1.143455334804187258e-04;
      coeff[i++] = 1.017329418791245745e-04;
      coeff[i++] = 8.963016994299180182e-05;
      coeff[i++] = 7.810390176563980187e-05;
      coeff[i++] = 6.737107771679166359e-05;
      coeff[i++] = 5.749734499893670157e-05;
      coeff[i++] = 4.855083669586239564e-05;
      coeff[i++] = 4.047985739147689084e-05;
      coeff[i++] = 3.333773756043754592e-05;
      coeff[i++] = 2.706796194080579544e-05;
      coeff[i++] = 2.161960945987747719e-05;
      coeff[i++] = 1.688333514513182512e-05;
      coeff[i++] = 1.282757684870063822e-05;
      coeff[i++] = 9.378429423559358081e-06;
      coeff[i++] = 6.483927540927511489e-06;
      coeff[i++] = 4.087556556233747215e-06;
      coeff[i++] = 2.171213304899379205e-06;
      coeff[i++] = 7.032054229443530871e-07;
      coeff[i++] = -3.496428729607497559e-07;
      coeff[i++] = -1.023396711039871587e-06;
      coeff[i++] = -1.372478565974311137e-06;
      coeff[i++] = -1.459379869922826604e-06;
      coeff[i++] = -1.360202319457568216e-06;
      coeff[i++] = -1.136083710760193440e-06;
      coeff[i++] = -8.680909991646923852e-07;
      coeff[i++] = -6.088353178687325521e-07;
      coeff[i++] = -4.007299546638757913e-07;
      coeff[i++] = -2.465687928286768722e-07;
      coeff[i++] = -1.625384444449434875e-07;
      coeff[i++] = -1.324181476569049330e-07;
      coeff[i++] = -1.401618573909420403e-07;
      coeff[i++] = -1.508301147293638958e-07;
      coeff[i++] = -1.613821173974822374e-07;
      coeff[i++] = -1.582714402722709418e-07;
      coeff[i++] = -1.411537038473996091e-07;
      coeff[i++] = -1.026428983344676106e-07;
      coeff[i++] = -5.995374376484994895e-08;
      coeff[i++] = -1.841297607113018711e-08;
      coeff[i++] = 1.397085941844044792e-08;
      coeff[i++] = 4.005588357804120100e-08;
      coeff[i++] = 5.227667848379822902e-08;
      coeff[i++] = 5.371026768821267312e-08;
      coeff[i++] = 4.661325481511005901e-08;
      coeff[i++] = 3.808905844758880895e-08;
      coeff[i++] = 2.751947397060087806e-08;
      coeff[i++] = 1.783793149014211838e-08;
      coeff[i++] = 9.819099451545187826e-09;
      coeff[i++] = 5.345259634929363256e-09;
      coeff[i++] = 2.425503812319305833e-09;
      coeff[i++] = 8.606694456227550170e-10;
    }
  }
