...
*/
  ...
  void setData_if(const std::vector<double> &keys, const std::vector<double> &values,
                  ...
                  bool alreadySorted = false);
  void setData_cplx(const std::vector<std::complex<double>> &data,
                    bool alreadySorted = true);
  void setData_if_cplx(const std::vector<std::complex<double>> &data,
                       const std::vector<bool> &selected,
                       bool alreadySorted = true);
  // -----
  ...
  // bfr ----
  void vaddData(std::vector<double>::const_iterator keys_beg, std::vector<double>::const_iterator keys_end,
                std::vector<double>::const_iterator values_beg, std::vector<double>::const_iterator values_end,
                bool alreadySorted = false);
  void vaddData_if(std::vector<double>::const_iterator keys_beg, std::vector<double>::const_iterator keys_end,
                   std::vector<double>::const_iterator values_beg, std::vector<double>::const_iterator values_end,
                   std::vector<bool>::const_iterator selected_beg, std::vector<bool>::const_iterator selected_end,
                   bool alreadySorted = false);

  void vaddData_cplx(std::vector<std::complex<double>>::const_iterator data_beg, std::vector<std::complex<double>>::const_iterator data_end,
                     bool alreadySorted = true);
...
*/
  ...
  void setData(std::vector<double>::const_iterator error_begin, std::vector<double>::const_iterator error_end);
  void setData(std::vector<double>::const_iterator errorMinus_begin, std::vector<double>::const_iterator errorMinus_end,
               std::vector<double>::const_iterator errorPlus_begin, std::vector<double>::const_iterator errorPlus_end);

  void vaddData(std::vector<double>::const_iterator error_begin, std::vector<double>::const_iterator error_end);
  void vaddData(std::vector<double>::const_iterator errorMinus_begin, std::vector<double>::const_iterator errorMinus_end,
                std::vector<double>::const_iterator errorPlus_begin, std::vector<double>::const_iterator errorPlus_end);
